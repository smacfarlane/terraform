...
func (e fixedExpression) BuildSource(w SourceWriter) {
	w.WriteString(e.Source)
}

func (e fixedExpression) ExpectedResult() Expected {
	return e.Expected
}

func (e fixedExpression) generator(rand *rand.Rand) Expression {
	return e
}
...
var fixedExpressions = []fixedExpression{
	{
		`local.string`,
		Expected{
			Type: cty.String,
